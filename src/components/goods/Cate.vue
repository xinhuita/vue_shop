...
<el-dialog title="添加分类" :visible.sync="addCateDialogVisible" width="50%" @close="addCateDialogClosed">
    ...
    <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="父级分类:">
            <!-- options 用来指定数据源 -->
            <!-- props用来指定配置对象 -->
            <el-cascader expandTrigger="hover" :options="parentCateList" :props="cascaderProps" @change="parentCateChanged" v-model="selectedKeys" clearable change-on-select></el-cascader>
        </el-form-item>
    </el-form>
...
<script>
    export default {
        ...
        methods: {
            ...
            //选择项发生变化触发
            parentCateChanged() {
                //如果selectedKeys中的length大于0，证明选中了父级分类，反之说明没有选中任何父级分类
